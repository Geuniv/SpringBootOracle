...
public class OcrService implements IOcrService {
    ...
    public OcrDTO getReadforImageText(OcrDTO pDTO) throws Exception {
        ...
        File imageFile = new File(CmmUtil.nvl(pDTO.getFilePath()) + "//" + CmmUtil.nvl(pDTO.getFileName())); // Controller에서 업로드 한 파일
        ...
        instance.setDatapath(ocrModel); // Tesseract 홈페이지에서 다운로드한 학습모델 파일들을 위치 설정
